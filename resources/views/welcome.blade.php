            ...
            <div class="row">
                <div class="col-lg-6 col-xl-5">
                    <div class="text-container">
                        ...
                        <p class="p-large">, Aplikasi Kasir (Laravel Project)</p>
                        @if (Route::has('login'))
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">Aplikasi Terkini</h5>
                            <p style="height: 150px;">Aplikasi Kasir
    ...
    <div id="details" class="basic-1">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-xl-7">
                    <div class="image-container">
                        <img class="img-fluid" src="https://raw.githubusercontent.com/laravel/art/master/logo-lockup/5%20SVG/2%20CMYK/1%20Full%20Color/laravel-logolockup-cmyk-red.svg" alt="alternative">
                    </div> <!-- end of image-container -->
                </div> <!-- end of col -->
                <div class="col-lg-6 col-xl-5">
                    <div class="text-container">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="grid">
                        <div class="element-item development">
                            <a href="article.html">
                                <img class="img-fluid" src="{{ asset('img') }}/projects/Project_1_Siadawa.PNG" alt="alternative">
                        ...
                        <div class="element-item development">
                            <a href="article.html">
                                <img class="img-fluid" src="{{ asset('img') }}/projects/Project_2_Informasi_Surat.PNG" alt="alternative">
                                <p><strong>Apps Informasi Surat Sederhana (PHP Native)</strong></p>
                            </a>
                        </div>
                        <div class="element-item development">
                            <a href="article.html">
                                <img class="img-fluid" src="{{ asset('img') }}/projects/Project_3_Akta_Tanah.PNG" alt="alternative">
                                <p><strong>Apps Akta Tanah Sederhana (PHP Native)</strong></p>
                            </a>
                        </div>
                        <div class="element-item development">
                            <a href="article.html">
                                <img class="img-fluid" src="{{ asset('img') }}/projects/Project_4_Sidak.PNG" alt="alternative">
                                <p><strong>Apps Sidak Sederhana (PHP Native)</strong></p>
                            </a>
                        </div>
                        <div class="element-item development">
                            <a href="article.html">
                                <img class="img-fluid" src="{{ asset('img') }}/projects/Project_5_Pendataan_Dosen_Mahasiswa.PNG" alt="alternative">
                                <p><strong>Apps Pendataan Dosen dan Mahasiswa Sederhana(PHP Native)</strong></p>
                            </a>
                        </div>
                        <div class="element-item development">
                            <a href="article.html">
                                <img class="img-fluid" src="{{ asset('img') }}/projects/Project_6_PKL.PNG" alt="alternative">
                                <p><strong>Apps Pendataan dan Penerima Pelamar Sederhana (PHP Native)</strong></p>
                            </a>
                        </div>
                        <div class="element-item development">
                            <a href="article.html">
                                <img class="img-fluid" src="{{ asset('img') }}/projects/Project_7_Sosial_Media.PNG" alt="alternative">
                                <p><strong>Apps Sosial Media Laravel 6 (Final Project)</strong></p>
                            </a>
                        </div>
                        <div class="element-item development">
                            <a href="article.html">
                                <img class="img-fluid" src="{{ asset('img') }}/projects/Project_8_Laravel_Film.PNG" alt="alternative">
                        ...
                        <div class="element-item development">
                            <a href="article.html">
                                <img class="img-fluid" src="{{ asset('img') }}/projects/Project_9_Aplikasi_Kasir.PNG" alt="alternative">
